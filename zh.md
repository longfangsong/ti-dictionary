...
| Green GC |  | 特性 | 使得GC过程中可以跳过 raft 层直接resolve lock。 | [文档](https://docs.pingcap.com/zh/tidb/stable/garbage-collection-configuration#tikv_gc_scan_lock_mode) |
...
| Storage |  | 概念 | 为某个 Engine 实现了 transactional KV APIs 和 raw KV APIs 后得到的就是一个Storage。 | [代码](https://github.com/tikv/tikv/blob/43d8b232ab9e2cd37548d7f3597f009379185863/src/storage/mod.rs#L91) |
